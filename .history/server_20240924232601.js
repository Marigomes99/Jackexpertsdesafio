...
const renderPage = (userName, pageContent) => {
    return `
        ...
        <head>
            ...
            <style>
                ...
                .iframe-container {
                    ...
                    width: 100%; 
                    height: 0; 
                    padding-top: 56.2225%; /* Para manter a proporção do iframe */
        ...
        <body>
            ...
            <div class="container">
                <a href="https://www.canva.com/design/DAGRuDIZuM0/IvcfhTw-2ocqRIUzShbD6Q/view?utm_content=DAGRuDIZuM0&utm_campaign=designshare&utm_medium=embeds&utm_source=link" target="_blank" rel="noopener">Seja bem-vindo ao Meu Desafio Jack Experts de Mari Gomes</a>
            </div>            
        </body>
        </html>
    `;

...
const path = require('path'); // Importa o módulo path para trabalhar com diretórios
require('dotenv').config(); // Carrega as variáveis de ambiente

const app = express();
const PORT = process.env.PORT || 3001; // Usando a porta definida na variável de ambiente ou 3001
...
// Conteúdo da página a partir do arquivo de variáveis de ambiente (.env)
